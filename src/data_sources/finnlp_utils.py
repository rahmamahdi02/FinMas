...
class FinNLPUtils:
  ...
  def cnbc_news_download(
      ...
      selected_columns: Annotated[list[str], "List of column names of news to return, default columns selected"] = [
...
if __name__ == "__main__":
    ...
    #print(obj.cnbc_news_download(keyword="tesla", save_path="cnbc_tesla.csv"))
    #print(obj.investor_place_news_download("tesla", save_path="invpl_tesla.csv"))
    #print(obj.sina_finance_news_download(start_date="2024-03-02", end_date="2024-03-02", save_path="sina_news.csv"))
    print(obj.finnhub_news_download(start_date="2024-03-02", end_date="2024-03-02", stock="AAPL", save_path="finnhub_aapl_news.csv"))
    #print(obj.xueqiu_social_media_download(stock="茅台", save_path="xueqiu_maotai.csv"))
    #print(obj.stocktwits_social_media_download(stock="AAPL", save_path="stocktwits_aapl.csv"))
